...
- [ ] Meets the repository's Definition of Ready (see `{{project.docs.orchestrator_brief}}`).
...
- [ ] Every technical task issue is linked as a GitHub sub-issue under a `type:story` or `type:epic` parent.
