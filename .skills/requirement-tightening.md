# Skill: Requirement Tightening

Used by: Product Analyst Agent (primarily), Main Orchestrator.

## Checklist

- [ ] Is the requirement stated as a user-observable outcome, not an implementation detail?
- [ ] Does it name the persona(s) affected?
- [ ] Are acceptance criteria explicit, testable, and free of "etc." / "as needed" language?
